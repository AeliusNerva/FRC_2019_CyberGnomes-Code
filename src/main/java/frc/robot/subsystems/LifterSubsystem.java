...
public class LifterSubsystem extends Subsystem {
 ...
 // public CANEncoder Encoder = new CANEncoder(MAXlift);
  ...
  public void GoToHighBallPosition() { // moving to given position
    ...
    // setting PID values
    //liftsetReference(280, ControlType.kPosition);
  ...
  lift2.setOutputRange(-1, 1);
  // setting PID values
  //liftsetReference(165, ControlType.kPosition);
...
lift2.setOutputRange(-1, 1);
// setting PID values
//liftsetReference(37, ControlType.kPosition);
...
lift2.setOutputRange(-1, 1);
// setting PID values
//liftsetReference(135, ControlType.kPosition);
...
lift2.setOutputRange(-1, 1);
// setting PID values
//liftsetReference(20, ControlType.kPosition);
...
public void GoToCargoShipPosition() { // moving to given position
  ...
  lift2.setOutputRange(-1, 1);
  // setting PID values
  //liftsetReference(120, ControlType.kPosition);
  lift2.setReference(-220, ControlType.kPosition);//orginal 320
  }
  public void movetoGrabHatch() {
          ...
          lift2.setOutputRange(-1, 1);
          // setting PID values
          //liftsetReference(10, ControlType.kPosition);
          lift2.setReference(-40, ControlType.kPosition);//orginal 320
  }
  public void movetoHome() {
    ...
    lift2.setOutputRange(-1, 1);
    // setting PID values
    //liftsetReference(1, ControlType.kPosition);
